...
# Automate Our Pipeline Deployment with Terraform
...
3. A GCE Instance
4. A GCS Bucket
5. PEM files to use in SSH'ing to the instances
6. Security groups that allow your IP address to SSH to the instances
7. cloud-init scripts to install Docker, Kubectl, and Minikube on the instances

Feel free to store it in a new folder in a file called `main.tf` and run the same commands you ran for the sample application.
...
When you are done, make sure to destroy what you created!
